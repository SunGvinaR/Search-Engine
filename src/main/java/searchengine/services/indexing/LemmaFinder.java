...
public class LemmaFinder { //TODO: до конца разобраться как работает
    ...
    //TODO:123
//    public ArrayList<String> morphInfo(String string) {
//        ArrayList<String> morph = new ArrayList<>();
//        String[] words = arrayContainsRussianWords(string);
//        for (String word : words){
//            List<String> wordInfo = luceneMorphology.getMorphInfo(word);
//            morph.addAll(wordInfo);
//        }
//        return morph;
//    }
}
